@extends('layouts.app')
@section('title', '商品列表')
huhuahuhufhuhufuhfuhhufhufuhfuh
@section('content')
    <div class="row">
                                ...
                                <div class="product-content">
                                    <div class="top">
                                        ...
                                        @if($product->type == \App\Models\Product::TYPE_SECKILL)
                                            ...
                                            @else
                                                <div  style="display: inline-block;margin-top:10px;margin-right: 20px;float:right;border-radius:10%;border: 1px solid #EA638C;color:#EA638C;padding:0 8px;">秒杀</div>
                                            @endif
                                        ...
                                        @elseif($product->price > 300 )
                                            <div  style="display: inline-block;margin-top:10px;margin-right: 0px;float:right;border-radius:10%;border: 1px solid #797596;color:#797596;padding:0 8px;">支持分期购</div>
                                        @endif
                                        <div class="title">
...
@section('scriptsAfterJs')
    <script>
        ...
        var typed = new Typed('#logo', {
            ...
            strings: ["^2000For Laravel Artist",'^2000Developed By ^1000黄向荣'], //输入内容, 支持html标签
            typeSpeed: 150, //打字速度
            backSpeed: 150 ,//回退速度
            showCursor: false,
            loop: true,   //是否循环
