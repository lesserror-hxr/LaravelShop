                        ...
                        <div class="installment-info">
                            <div class="line">
                                ...
                                <div class="line-value">
                                    <a target="_blank" href="{{ route('orders.show', ['order' => $installment->order]) }}">查看</a>
                                </div>
                            </div>
                            <div class="line">
                        ...
                        <div class="installment-next text-right">
                            ...
                            @else
                                ...
                                <div class="payment-buttons">
                                    <a class="btn btn-primary btn-sm" href="{{ route('installments.alipay', ['installment' => $installment]) }}">支付宝支付</a>
    ...
    <script>
        $(document).ready(function() {
            $('#btn-wechat').click(function() {
                swal({
                    content: $('<img src="{{ route('installments.wechat', ['installment' => $installment]) }}" />')[0],
